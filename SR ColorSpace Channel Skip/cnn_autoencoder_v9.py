...
#
  ...
  def create_2D_decoder( self, decoder_config):
    ...
    with tf.variable_scope( decoder_id ):
      ...
      decoder[ 'skip_connect'] =  decoder_config['skip_connect']
      ...
      for i in range(0, last_layer):
          ...
          if decoder['skip_connect']:
            print('    generating upconvolution variables with skip connection' + layer_id)
            ...
            print('    generating upconvolution variables no skip connection' + layer_id)
            decoder['2D_variables'].append(layers.decoder_variables_2D_no_SC(layer_id, layout[i],
      ...
      if decoder['skip_connect']:
          ...
          for i in range(0, len(self.config.layers['upscale_no_SC'])):
              layout.append(self.config.layers['upscale_no_SC'][i])
