...
# NETWORK MODEL NAME
network_model = 'SR_RGB_DIAG_PLOSS'

data_path = '/home/aa/Python_projects/Data_train/super_resolution/Data_Cross_Diag/'
tf_log_path = '/data/tf_logs/'
# data_path = 'H:\\trainData\\Data_Cross_Diag\\'

# data_path = 'H:\\trainData\\'
# CURRENT TRAINING DATASET
training_data = [
    # 'lf_benchmark_HSV.hdf5',
    data_path + 'lf_patch_benchmark_sr_CrossDiag.hdf5',
    data_path + 'lf_patch_synthetic_rgb_CrossDiag_1.hdf5',
    data_path + 'lf_patch_synthetic_rgb_CrossDiag_2.hdf5',
    data_path + 'lf_patch_synthetic_rgb_CrossDiag_3.hdf5',
    data_path + 'lf_patch_synthetic_rgb_CrossDiag_4.hdf5',
    data_path + 'lf_patch_synthetic_rgb_CrossDiag_5.hdf5',
    data_path + 'lf_patch_synthetic_rgb_CrossDiag_6.hdf5',
    data_path + 'lf_patch_synthetic_rgb_CrossDiag_7.hdf5',
    data_path + 'lf_patch_synthetic_rgb_CrossDiag_8.hdf5',
    data_path + 'lf_patch_synthetic_rgb_CrossDiag_9.hdf5',
    data_path + 'lf_patch_synthetic_rgb_CrossDiag_11.hdf5',
    data_path + 'lf_patch_synthetic_rgb_CrossDiag_12.hdf5',
    data_path + 'lf_patch_synthetic_rgb_CrossDiag_13.hdf5',
    data_path + 'lf_patch_synthetic_rgb_CrossDiag_14.hdf5',
    data_path + 'lf_patch_synthetic_rgb_CrossDiag_15.hdf5',
...
layer_config = [
    {
      ...
      'final':  [
                { 'conv'   : [ 1, 1, int(C/2)*patch_weight, int(C/2)],
                  'stride' : [ 1, 1, 1, 1 ]
                },]

    },
    {
        'id': 'RGB1',  # 'YUV', 'RGB', 'YCBCR', 'LAB' and any combinations
        'channels': int(C/2),
        'start': 3,
        'end': 6,
        'layout': [
...
layers[ '2D_encoder_nodes' ] = [3*3*3*L7]#[2*3*3*3*L7]
...
decoders_2D = [
    {
      ...
      'skip_id': ['RGB', 'RGB1'],
      'percep_loss': ['block1','block2', 'block3']
    },
]
